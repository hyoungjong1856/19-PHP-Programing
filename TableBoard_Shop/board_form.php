					...
					<table>
						...
						<tr>
                            ...
                            if(isset($_GET[num])) { //update 의 경우!
                                ?>
                                <td class="column1"> <input name="date" type="text" value="<? echo $row[date]#TODO: 기존 정보 표시 ?>" /> </td>
                                ...
                                <td class="column6"> $<span id="total"> <? echo $row[price] * $row[quantity]#TODO: 정보 표시 ?> </span> </td>
                                <?php
                            } else {
                                ?>
