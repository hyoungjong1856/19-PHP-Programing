...
<body>
    ...
    {
        // 겨울
        $bg_img_url = "img/판다.jpg";
    }
    else if($current_month < 6 && $current_month > 2)
    {
        // 봄
        $bg_img_url = "https://cdn.pixabay.com/photo/2014/02/27/16/10/spring-276014__340.jpg";
     }
    else if($current_month < 9 && $current_month > 5)
    {
        // 여름
    ...
    <header style="background: url('<? echo $bg_img_url?>') no-repeat center center;"
            background>
      <div class="container">
        <div class="row">
          <div class="col-xs-6">
